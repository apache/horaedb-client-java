...
public class TokenMgrException extends RuntimeException {
    ...
    /** Full Constructor. */
    public TokenMgrException(boolean EOFSeen, int lexState, int errorLine, int errorColumn, String errorAfter,
                             int curChar, int reason) {
        this(LexicalErr(EOFSeen, lexState, errorLine, errorColumn, errorAfter, curChar), reason);
    }
}
/* ParserGeneratorCC - OriginalChecksum=14e3d675e6e8e95390f5e2ca56a6a76c (do not edit this line) */
