 ...
 */
/* CeresDBxSqlParserTokenManager.java */
/* Generated by: ParserGeneratorCC: Do not edit this line. CeresDBxSqlParserTokenManager.java */
...
public class CeresDBxSqlParserTokenManager implements CeresDBxSqlParserConstants {
    ...
    public void CommonTokenAction(Token t) {
        if (t.kind != CeresDBxSqlParserConstants.SEMICOLON) {
            ...
            if (t.kind != CeresDBxSqlParserConstants.EOF) {
                validTokens++;
            }
        }
    }
    ...
    CeresDBxSqlStatement build(ParseHandler handler) {
        String sqlStmt = builder.toString();
        CeresDBxSqlStatement s = null;
        if (handler != null) {
            s = handler.handleStatement(sqlStmt, stmtType, database, tables, parameters, positions);
        }

        if (s == null) {
            s = new CeresDBxSqlStatement(sqlStmt, stmtType, database, tables, parameters, positions);
        }
    ...
    /** Constructor. */
    public CeresDBxSqlParserTokenManager(SimpleCharStream stream) {
        input_stream = stream;
    }

    /** Constructor. */
    public CeresDBxSqlParserTokenManager(SimpleCharStream stream, int lexState) {
        ReInit(stream);
        SwitchTo(lexState);
    }
